...
set style line 1 lt rgb "#253494" lw 4 pt 8 ps 1.5
set style line 2 lt rgb "#2b8cbe" lw 4 pt 6 ps 1.5
set style line 3 lt rgb "#74c476" lw 4 pt 2 ps 1.5
set style line 4 lt rgb "#00A000" lw 4 pt 9 ps 1.5
set style line 5 lt rgb "#d4b9da" lw 4 pt 12 ps 1.5
set style line 6 lt rgb "#4F4F4F" lw 4
...
plot 'data/Experiment-Scalability-MCI-RealWorld.dat' \
     using ($0+1):1 smooth cumulative with filledcurves y1=0 fs transparent solid 0.5 ls 2 title 'Access Analyzer(Z3)', \
     '' using ($0+1):2 smooth cumulative with filledcurves y1=0 fs transparent solid 0.5 ls 1 title 'Access Analyzer(CVC5)', \
     '' using ($0+1):4 smooth cumulative with filledcurves y1=0 fs transparent solid 0.5 ls 3 title 'AccessRefinery'
...
plot 'data/Experiment-Scalability-RRI-RealWorld.dat' \
     using ($0+1):1 smooth cumulative with filledcurves y1=0 fs transparent solid 0.5 ls 2 title 'Baseline(Z3)', \
     '' using ($0+1):2 smooth cumulative with filledcurves y1=0 fs transparent solid 0.5 ls 1 title 'Baseline(CVC5)', \
     '' using ($0+1):4 smooth cumulative with filledcurves y1=0 fs transparent solid 0.5 ls 3 title 'AccessRefinery'