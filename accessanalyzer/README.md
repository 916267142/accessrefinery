...
```bash
$ cd accessanalyzer
$ echo 'export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:'$(pwd)'/lib/z3-4.15.0/bin' >> ~/.bashrc
$ source ~/.bashrc
```
...
```bash
$ cp -r ./archive_result/reduced_result ./reduced_result
$ cp -r ./archive_result/unreduced_result ./unreduced_result
```
