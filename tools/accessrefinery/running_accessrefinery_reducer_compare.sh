...
sh tools/accessrefinery/compare.sh archive_results/accessrefinery_bdd_reducer_10rs/Correctness/  \
...
sh tools/accessrefinery/compare.sh archive_results/accessrefinery_bdd_reducer_10rs/Scalability_05Keys/  \
...
sh tools/accessrefinery/compare.sh archive_results/accessrefinery_bdd_reducer_10rs/Scalability_06Keys/  \
